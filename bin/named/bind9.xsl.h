...
static char xslmsg[] =
	...
	"or "
	"substring(@name,1,3) != 'RES']\">['<xsl:value-of "
	...
	" <table class=\"counters\">\n"
	" <xsl:for-each "
	"select=\"counters[@type=&quot;rcode&quot;]/counter[.&gt;0 "
	"and @name != &quot;QryAuthAns&quot;]\">\n"
	" <xsl:sort select=\".\"/>\n"
	...
	" <table class=\"counters\">\n"
	" <xsl:for-each "
	"select=\"counters[@type=&quot;gluecache&quot;]/counter[. "
	"&gt; 0]\">\n"
	" <xsl:sort select=\".\"/>\n"
	" <xsl:variable name=\"css-class11\">\n"
	" <xsl:choose>\n"
