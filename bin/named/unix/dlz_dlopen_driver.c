...
static isc_result_t
dlopen_dlz_allnodes(const char *zone,
		    void *driverarg,
		    void *dbdata,
...
static isc_result_t
dlopen_dlz_allowzonexfr(void *driverarg,
			void *dbdata,
			const char *name,
			const char *client)
{
...
static isc_result_t
dlopen_dlz_authority(const char *zone,
		     void *driverarg,
		     void *dbdata,
...
static isc_result_t
dlopen_dlz_findzonedb(void *driverarg,
		      void *dbdata,
		      const char *name,
...
static isc_result_t
dlopen_dlz_lookup(const char *zone,
		  const char *name,
		  void *driverarg,
		  void *dbdata,
		  dns_sdlzlookup_t *lookup,
 ...
 */
static isc_result_t
dlopen_dlz_create(const char *dlzname,
		  unsigned int argc,
		  char *argv[],
		  void *driverarg,
		  void **dbdata)
 ...
 */
static isc_result_t
dlopen_dlz_newversion(const char *zone,
		      void *driverarg,
		      void *dbdata,
		      void **versionp)
{
 ...
 */
static void
dlopen_dlz_closeversion(const char *zone,
			bool commit,
			void *driverarg,
			void *dbdata,
			void **versionp)
 ...
 */
static isc_result_t
dlopen_dlz_configure(dns_view_t *view,
		     dns_dlzdb_t *dlzdb,
		     void *driverarg,
		     void *dbdata)
{
 ...
 */
static bool
dlopen_dlz_ssumatch(const char *signer,
		    const char *name,
		    const char *tcpaddr,
		    const char *type,
		    const char *key,
 ...
 */
static isc_result_t
dlopen_dlz_addrdataset(const char *name,
		       const char *rdatastr,
		       void *driverarg,
		       void *dbdata,
		       void *version)
 ...
 */
static isc_result_t
dlopen_dlz_subrdataset(const char *name,
		       const char *rdatastr,
		       void *driverarg,
		       void *dbdata,
		       void *version)
 ...
 */
static isc_result_t
dlopen_dlz_delrdataset(const char *name,
		       const char *type,
		       void *driverarg,
		       void *dbdata,
		       void *version)
