...
static void update_addordelete(isc_mem_t*mctx,
			       char*cmdline,
			       bool isdelete,
			       dns_name_t*name);
...
static bool
addserver(const char*server,isc_sockaddrlist_t*list,isc_sockaddr_t*sockaddr)
{
...
static void
update_addordelete(isc_mem_t*mctx,char*cmdline,bool isdelete,dns_name_t*name)
{
	isc_result_t result;
	uint32_t ttl;
	char*word;
