...
#define atomic_init(obj, desired)		\
	{ isc_mutex_init(&(obj)->m); (void)isc_mutex_lock(&(obj)->m); (obj)->v = desired; (void)isc_mutex_unlock(&(obj)->m); }
#define atomic_load_explicit(obj, order)	\
	({ typeof((obj)->v) __v; (void)isc_mutex_lock(&(obj)->m); __v= (obj)->v; (void)isc_mutex_unlock(&(obj)->m); __v;} )
#define atomic_store_explicit(obj, desired, order)	\
	{(void)isc_mutex_lock(&(obj)->m); (obj)->v = desired; (void)isc_mutex_unlock(&(obj)->m); }
#define atomic_fetch_add_explicit(obj, arg, order)	\
	({ typeof((obj)->v) __v; (void)isc_mutex_lock(&(obj)->m); __v= (obj)->v; (obj)->v += arg; (void)isc_mutex_unlock(&(obj)->m); __v;} )
...
#define atomic_compare_exchange_strong_explicit(obj, expected, desired, succ, fail) \
	({ bool __v; (void)isc_mutex_lock(&(obj)->m); __v = ((obj)->v == *expected); *expected = (obj)->v; (obj)->v = __v ? desired : (obj)->v; (void)isc_mutex_unlock(&(obj)->m); __v;} )
