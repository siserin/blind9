...
static isc_result_t
base32_totext(isc_region_t *source,
	      int wordlength,
...
static inline void
base32_decode_init(base32_decode_ctx_t *ctx,
		   int length,
		   const char base[],
		   bool pad,
		   isc_buffer_t *target)
...
static isc_result_t
base32_tobuffer(isc_lex_t *lexer,
		const char base[],
		bool pad,
		isc_buffer_t *target,
		int length)
...
static isc_result_t
base32_decodestring(const char *cstr,
		    const char base[],
		    bool pad,
		    isc_buffer_t *target)
{
...
static isc_result_t
base32_decoderegion(isc_region_t *source,
		    const char base[],
		    bool pad,
		    isc_buffer_t *target)
{
