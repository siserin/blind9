 ...
 */
static isc_result_t
register_thread(unsigned long thrd,
		isc_condition_t*gblcond,
...
static isc_result_t
find_thread_condition(unsigned long thrd,
...
isc_result_t
isc_condition_waituntil(isc_condition_t*cond,isc_mutex_t*mutex,isc_time_t*t) {
	DWORD milliseconds;
