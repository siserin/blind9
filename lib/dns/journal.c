...
static isc_result_t
journal_write_xhdr(dns_journal_t *j,
		   uint32_t size,
		   uint32_t serial0,
		   uint32_t serial1)
{
	     ...
	     const char *filename)
{
	...
	CHECK(diff_namespace(dba, dbvera, dbb, dbverb, DNS_DB_NSEC3ONLY,
			     diff));
