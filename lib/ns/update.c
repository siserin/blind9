 ...
 */
static isc_result_t
checkqueryacl(ns_client_t*client,
	      dns_acl_t*queryacl,
	      dns_name_t*zonename,
	      dns_acl_t*updateacl,
 ...
 */
static isc_result_t
checkupdateacl(ns_client_t*client,
	       dns_acl_t*acl,
	       const char*message,
	       dns_name_t*zonename,
	       bool slave,
 ...
 */
static isc_result_t
do_diff(dns_diff_t*updates,dns_db_t*db,dns_dbversion_t*ver,dns_diff_t*diff)
{
	isc_result_t result;
 ...
 */
static isc_result_t
cname_incompatible_rrset_exists(dns_db_t*db,
				dns_dbversion_t*ver,
				dns_name_t*name,
				bool*exists) {
	isc_result_t result;
 ...
 */
static void
get_current_rr(dns_message_t*msg,
 ...
 */
static isc_result_t
check_soa_increment(dns_db_t*db,
		    dns_dbversion_t*ver,
 ...
 */
static isc_result_t
check_dnssec(ns_client_t*client,
	     dns_zone_t*zone,
	     dns_db_t*db,
	     dns_dbversion_t*ver,
	     dns_diff_t*diff)
 ...
 */
static isc_result_t
add_nsec3param_records(ns_client_t*client,
		       dns_zone_t*zone,
		       dns_db_t*db,
		       dns_dbversion_t*ver,
		       dns_diff_t*diff)
