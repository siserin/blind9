...
static isc_result_t
ns_interface_create(ns_interfacemgr_t*mgr,
		    isc_sockaddr_t*addr,
		    const char*name,
...
static isc_result_t
ns_interface_setup(ns_interfacemgr_t*mgr,
		   isc_sockaddr_t*addr,
		   const char*name,
		   ns_interface_t**ifpret,
		   bool accept_tcp,
...
static void
setup_listenon(ns_interfacemgr_t*mgr,isc_interface_t*interface,in_port_t port)
{
	isc_sockaddr_t*addr;
	isc_sockaddr_t*old;
...
static isc_result_t
ns_interfacemgr_scan0(ns_interfacemgr_t*mgr,
...
isc_result_t
ns_interfacemgr_adjust(ns_interfacemgr_t*mgr,ns_listenlist_t*list,bool verbose)
{
